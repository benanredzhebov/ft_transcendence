...
/*   Updated: 2025/04/18 11:57:39 by beredzhe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
import { GameEngine } from '../game/GameEngine.ts'; // Custom module that handles game logic
...
setInterval(() => {
	...
	// console.log('Emitting state:', state); //delete later!
