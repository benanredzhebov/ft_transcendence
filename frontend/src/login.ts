...
export function renderLogin() {
  ...
  middleContentContainer.className = "login-middle-container";

  // Forgot Password Link
  const forgotPasswordLink = document.createElement('div');
  forgotPasswordLink.id = "forgot-password";
  forgotPasswordLink.className = "login-forgot-password";
  ...
  bottomButtonsContainer.className = "login-bottom-buttons-container";


  // Sign Up Link Paragraph
  const signUpParagraph = document.createElement('p');
  signUpParagraph.className = "login-signup-paragraph";
  ...
  closeButtonContainer.className = "login-close-button";
  ...
  form.addEventListener('submit', async (e) => {
      ...
      if (response.ok && data.success !== false) {
        ...
        connectSocket(data.token); // ***Connect the socket***
          ...
          const loginButtonSpan = loginButton.querySelector('span');
          if (loginButtonSpan) loginButtonSpan.textContent = 'Login';
      }
  });
